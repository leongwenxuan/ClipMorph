...
function isIpcSuccess(response) {
...
function Settings({ onClose }) {
  ...
  const [editingHotkey, setEditingHotkey] = reactExports.useState(false);
  const [hotkeyInput, setHotkeyInput] = reactExports.useState("");
  const [hotkeyError, setHotkeyError] = reactExports.useState(null);
  const [hasApiKey, setHasApiKey] = reactExports.useState(false);
  const [maskedApiKey, setMaskedApiKey] = reactExports.useState(null);
  const [editingApiKey, setEditingApiKey] = reactExports.useState(false);
  ...
  const handleToggleTransform = async (transformKey) => {
    if (!settings) return;
    ...
    try {
      ...
      if (isIpcSuccess(response)) {
        if (response.data.success) {
          setSettings(
            (prev) => prev ? { ...prev, "hotkey.pushToTalk": response.data.hotkey } : null
          );
          setEditingHotkey(false);
          setHotkeyInput("");
        } else {
  ...
  if (!settings) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-overlay", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-panel", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-error", children: "Failed to load settings" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "settings-close-btn", onClick: onClose, children: "Close" })
    ] }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-overlay", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "settings-header", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "settings-close-btn", onClick: onClose, "aria-label": "Close", children: "×" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "settings-section", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-row api-key-row", children: [
          ...
          editingApiKey ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "api-key-editor", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "api-key-actions", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: apiKeySaving ? "Saving..." : "Save"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
          ...
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "api-key-display", children: hasApiKey ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "api-key-masked", children: maskedApiKey }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "api-key-edit-btn", onClick: handleEditApiKey, children: "Change" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                className: "api-key-delete-btn",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "api-key-missing", children: "Not configured" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "api-key-add-btn", onClick: handleEditApiKey, children: "Add Key" })
          ] }) })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "settings-section", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-row hotkey-row", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "Push-to-Talk" }),
          editingHotkey ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hotkey-editor", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hotkey-actions", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
          ...
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "hotkey-display clickable", onClick: handleEditHotkey, children: settings["hotkey.pushToTalk"] })
        ] }),
        hotkeyError && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hotkey-error", children: hotkeyError })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "settings-section", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Transforms" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "settings-hint", children: "Enable or disable transform capabilities" }),
        Object.entries(TRANSFORM_LABELS).map(([key, label]) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-row", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: `transform-${key}`, children: label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                id: `transform-${key}`,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "settings-section", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "setting-row", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "UI Theme" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "theme-display", children: settings["ui.theme"] })
        ] })
      ] })
    ] }),
...
function LastAction() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `last-action ${lastAction.success ? "success" : "failure"}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "last-action-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "last-action-status", children: lastAction.success ? "✓" : "✗" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "last-action-capability", children: getCapabilityLabel(lastAction.capability) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "last-action-transcript", children: [
      '"',
      lastAction.transcript,
      '"'
    ] }),
    !lastAction.success && lastAction.error && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "last-action-error", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "error-label", children: "Error:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "error-message", children: lastAction.error })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "last-action-meta", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "last-action-time", children: formatTime(lastAction.timestamp) }),
      lastAction.jobId && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "last-action-job", children: [
        "Job: ",
        lastAction.jobId.slice(0, 8),
        "..."
      ] })
    ] })
  ] });
}
function JobStatus({ onCancel }) {
  ...
  reactExports.useEffect(() => {
    ...
    const unsubscribe = window.clipmorph.onEvent((event) => {
      ...
      if (automationEvents.includes(event.type)) {
        const payload = event.payload;
        if (payload?.job) {
  ...
  const formatDuration = (startMs, endMs) => {
    ...
    if (duration < 1e3) return "<1s";
    if (duration < 6e4) return `${Math.floor(duration / 1e3)}s`;
    return `${Math.floor(duration / 6e4)}m ${Math.floor(duration % 6e4 / 1e3)}s`;
  };
  if (!activeJob && recentJobs.length === 0) {
    return null;
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "job-status", children: [
    activeJob && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "active-job", style: { borderColor: getStatusColor(activeJob.status) }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "job-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "job-icon", children: getStatusIcon(activeJob.status) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "job-type", children: activeJob.type }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "job-duration", children: formatDuration(activeJob.createdAt) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "job-details", children: [
        activeJob.currentStep && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "job-step", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "step-label", children: "Step:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "step-value", children: activeJob.currentStep })
        ] }),
        activeJob.status === "needs_input" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "needs-input-banner", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "needs-input-header", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "needs-input-icon", children: "⚠️" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "needs-input-reason", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "needs-input-text", children: activeJob.needsInputMessage || "Please complete the required action in the browser, then click Continue." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "needs-input-actions", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "continue-btn", onClick: handleContinue, children: "Continue" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "cancel-btn-small", onClick: handleCancel, children: "Cancel" })
          ] })
        ] })
      ] }),
      !isTerminal(activeJob.status) && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "cancel-btn", onClick: handleCancel, title: "Cancel job", children: "Cancel" })
    ] }),
    recentJobs.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "recent-jobs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "toggle-icon", children: isExpanded ? "▼" : "▶" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "toggle-text", children: [
              "Recent Jobs (",
              recentJobs.length,
              ")"
            ] })
      ...
      isExpanded && /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "recent-list", children: recentJobs.map((job) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "recent-item", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "job-icon", children: getStatusIcon(job.status) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "job-type", children: job.type }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "job-duration", children: formatDuration(job.createdAt, job.updatedAt) })
      ] }, job.id)) })
    ] })
  ] });
}
function App() {
  ...
  const [liveTranscript, setLiveTranscript] = reactExports.useState(null);
  const [isExpanded, setIsExpanded] = reactExports.useState(false);
  const [showTextInput, setShowTextInput] = reactExports.useState(false);
  const [textCommand, setTextCommand] = reactExports.useState("");
    ...
    const unsubscribe = window.clipmorph.onEvent((event) => {
      if (event.type === EventTypes.STATUS_CHANGED && event.payload) {
        ...
        if (payload.status === "idle") {
          setTimeout(() => setLiveTranscript(null), 3e3);
        }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `app expanded ${isRecording ? "recording" : ""}`, children: [
    isRecording && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "recording-overlay", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "recording-indicator", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "recording-dot" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "recording-text", children: "Recording" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "recording-waveform", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "wave-bar" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "wave-bar" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "wave-bar" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "wave-bar" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "app-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "header-left", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "app-title", children: "ClipMorph" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "header-actions", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "compact-btn collapse-btn", onClick: handleToggleWindow, title: "Collapse", children: "▲" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "app-main", children: !isRecording && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "status-container", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "status-indicator", style: { backgroundColor: getStatusColor() } }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "status-text", children: getStatusText() })
      ] }),
      liveTranscript && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "live-transcript", children: liveTranscript }),
      showMicWarning && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "permission-warning", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "warning-icon", children: "🎤" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "warning-text", children: permissions.microphone === "denied" || permissions.microphone === "restricted" ? "Microphone denied" : "Microphone required" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "permission-btn", onClick: handleRequestMicPermission, children: permissions.microphone === "not-determined" ? "Enable" : "Request" })
      ] }),
      showAccessibilityWarning && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "permission-warning", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "warning-icon", children: "⌨️" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "warning-text", children: "Accessibility required for hotkey" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "permission-btn", onClick: handleRequestAccessibilityPermission, children: "Open Settings" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "permission-status", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: `permission-badge ${permissions.voiceEnabled ? "granted" : "denied"}`,
            children: getMicPermissionText()
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            ...
            children: permissions.hotkeysEnabled ? "Hotkey: ✓" : "Hotkey: ✗"
          }
        )
      ] })
    ] }) }),
