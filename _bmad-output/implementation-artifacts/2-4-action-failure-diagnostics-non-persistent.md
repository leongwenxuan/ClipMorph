...
**Story ID:** 2.4  
**Story Key:** `2-4-action-failure-diagnostics-non-persistent`  
**Epic:** 2
...
- [x] Task 1: a job fails (transcription/transform/automation) (AC: #1)
...
- Story definition + ACs: `_bmad-output/planning-artifacts/epics.md` (Story 2.4)
...
- `_bmad-output/implementation-artifacts/2-4-action-failure-diagnostics-non-persistent.md`
