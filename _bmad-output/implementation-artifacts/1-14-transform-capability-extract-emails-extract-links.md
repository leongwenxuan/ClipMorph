...
**Story ID:** 1.14  
**Story Key:** `1-14-transform-capability-extract-emails-extract-links`  
**Epic:** 1
...
- [ ] Task 1: the clipboard contains text with emails (AC: #1)
...
- Story definition + ACs: `_bmad-output/planning-artifacts/epics.md` (Story 1.14)
...
- `_bmad-output/implementation-artifacts/1-14-transform-capability-extract-emails-extract-links.md`
