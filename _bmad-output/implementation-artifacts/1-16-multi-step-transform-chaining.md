...
**Story ID:** 1.16  
**Story Key:** `1-16-multi-step-transform-chaining`  
**Epic:** 1
...
- [x] Task 1: a transcript implies a chain (e.g., "compute then convert then format") (AC: #1)
...
- Story definition + ACs: `_bmad-output/planning-artifacts/epics.md` (Story 1.16)
...
- `_bmad-output/implementation-artifacts/1-16-multi-step-transform-chaining.md`
- `packages/core/src/intent/chain-parser.ts` - Chain parsing logic
- `packages/core/src/__tests__/chain-parser.test.ts` - Chain parser tests
- `src/main/services/transform-service.ts` - Added `executeChain` method
- `src/main/services/intent-service.ts` - Added chain handling in `handleTransformIntent`