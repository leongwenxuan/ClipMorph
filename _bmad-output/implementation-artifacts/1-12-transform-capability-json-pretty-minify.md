...
**Story ID:** 1.12  
**Story Key:** `1-12-transform-capability-json-pretty-minify`  
**Epic:** 1
...
- Story definition + ACs: `_bmad-output/planning-artifacts/epics.md` (Story 1.12)
...
- `_bmad-output/implementation-artifacts/1-12-transform-capability-json-pretty-minify.md`
